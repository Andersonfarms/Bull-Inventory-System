...
APP_CONFIG = {
    ...
    "machine_models": ["12X", "18X", "20X", "22X", "25X", "40X", "1100X", "Bucket", "Auger", "Ripper", "Rake", "Forks", "Wood Splitter", "Hedge Trimmers", "Hammer", "Mower", "Tilt Bucket", "Other"],
    ...
    with tab1:
        ...
        with st.form("add_form", clear_on_submit=True):
            ...
            with col2:
                ...
                new_desc = st.selectbox("Part Description", ["N/A", "Cylinder", "Guard", "Air Filter", "Oil Filter", "Hydraulic Filter", "Fuel Filter", "Hydraulic Hose", "O-Rings / Seals", "Track Assembly", "Sprocket / Idler", "Teeth / Cutting Edge", "Pins & Bushings", "Electrical Relay / Fuse", "Sensors", "Hardware / Fasteners", "Fluids / Grease", "Other"])
